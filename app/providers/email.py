...
from app.core.log_utils import mask_email
...
class SendGridEmailProvider(DeliveryProvider):
    async def send(
        ...
        logger.info(
            ...
            extra={
                "event": "provider_delivery_started",
                "channel": "email",
        ...
        try:
            ...
            logger.exception(
                ...
                extra={
                    "event": "provider_delivery_failed",
                    "channel": "email",
                    "recipient": mask_email(recipient),
                },
            )
        ...
        logger.info(
            "Email provider completed",
            extra={
                "event": "provider_delivery_completed",
                "channel": "email",
                "recipient": mask_email(recipient),
                "success": success,
